...
Use the dark mode switch in the top bar to toggle between light and dark themes. The current palette and theme are saved when you export, and the exported HTML has its own theme switch in the left sidebar.

You can also change the accent palette from the settings. The palette affects the colors used for links, active items, and headings.
