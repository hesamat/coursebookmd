...
- **controllers/** — App controllers composed by app.js (coursebook-opener, chapter-renderer, editor-controller, file-watcher, link-validation-controller, live-preview, local-assets-controller, menu-controller, presentation-controller)
